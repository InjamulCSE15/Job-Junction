                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="flex items-end justify-between">
                            ...
                            <div className="text-end">
                                ...
                                <Link className="btn-link no-underline text-sm bg-gray-800 px-2 py-1 text-white rounded-md hover:border hover:border-gray-800 hover:bg-white hover:text-gray-800 hover:no-underline hover:font-medium">View Details</Link>
                            </div>
                        </div>
                    </div>
                </div>
